...
object Constant {
    ...
    const val NOTIFICATION_CHANNEL_STEP_COUNT_ID = "NOTIFICATION_CHANNEL_ID_STEP_COUNT"
    const val NOTIFICATION_CHANNEL_STEP_COUNT_NAME = "NOTIFICATION_CHANNEL_ID_STEP_COUNT"
    const val NOTIFICATION_CHANNEL_TRACKING_ID = "NOTIFICATION_CHANNEL_ID_TRACKING"
    const val NOTIFICATION_CHANNEL_TRACKING_NAME = "NOTIFICATION_CHANNEL_TRACKING_NAME"
